...
export default function Range() {
  ...
  const isFavorite = favorites.includes("Range")
  ...
  const galleryImages = [
    ...
    require("../../assets/images/range2.jpg"), 
    require("../../assets/images/range3.jpg"), 
  ]
  ...
  const barDetails = {
    name: "Range",
    description:
      "Range is a unique sports bar and entertainment venue in Gainesville that combines traditional bar elements with an indoor shooting range. The establishment offers a variety of craft beers, cocktails, and pub food alongside a state-of-the-art shooting range with professional instructors. It's a popular spot for those looking for an unconventional night out that combines socializing with recreational shooting.",
    address: "3310 SW Archer Rd, Gainesville, FL 32608",
    phone: "(352) 745-7550",
    website: "https://rangeginesville.com",
    socials: {
      instagram: "rangegnv",
      facebook: "RangeGainesville",
      twitter: "RangeGNV",
    },
    hours: [
    ...
    deals: [
      { day: "Monday", title: "Military Monday", description: "20% off for military personnel" },
      { day: "Tuesday", title: "Target Tuesday", description: "$5 off range time, $4 craft beers" },
      { day: "Wednesday", title: "Ladies Night", description: "Half-price range time for ladies, $5 wine" },
      { day: "Thursday", title: "Thirsty Thursday", description: "$3 Domestic Drafts, $5 Well Drinks" },
      { day: "Friday", title: "Friday Happy Hour", description: "2-for-1 Drinks (4-7 PM), $10 off range packages" },
      { day: "Saturday", title: "Weekend Special", description: "Group rates for 4+ people" },
      { day: "Sunday", title: "Sunday Funday", description: "Family package deals, kids shoot free with adults" },
    ],
    currentWaitTime: 20,
    coverCharge: 10,
  }
